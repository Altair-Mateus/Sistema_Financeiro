unit SistemaFinanceiro.View.BxMulti.InfosBxCr;
...
var
  frmInfoBxMult: TfrmInfoBxMultCr;
...
procedure TfrmInfoBxMultCr.btnCancelarClick(Sender: TObject);
begin
  ModalResult := MrCancel;
end;

procedure TfrmInfoBxMultCr.btnConfirmarClick(Sender: TObject);
begin
  ...
  begin
    ...
    edtValor.SetFocus;
    Application.MessageBox('Valor pago não pode ser maior que o valor das parcelas!', 'Atenção',
...
procedure TfrmInfoBxMultCr.btnPesqFrPgtoClick(Sender: TObject);
begin
...
procedure TfrmInfoBxMultCr.BuscaNomeFrPgto;
var
  NomeFrPgto: String;
...
function TfrmInfoBxMultCr.CalcPorcentDesc: Currency;
var
  ValorFinal: Currency;
...
function TfrmInfoBxMultCr.CalcValorDesc: Currency;
var
  ValorCp: Currency;
  ValorDesc: Currency;
  ValorFinal: Currency;
...
procedure TfrmInfoBxMultCr.checkDescontoClick(Sender: TObject);
begin
...
procedure TfrmInfoBxMultCr.edtCodFrPgtoExit(Sender: TObject);
begin
...
procedure TfrmInfoBxMultCr.edtPorcDescKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  edtValor.Text := CurrToStr(CalcPorcentDesc);
end;

procedure TfrmInfoBxMultCr.edtPorcDescKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  edtValor.Text := CurrToStr(CalcPorcentDesc);
end;

procedure TfrmInfoBxMultCr.edtValorDescKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  edtValor.Text := CurrToStr(CalcValorDesc);
end;

procedure TfrmInfoBxMultCr.edtValorDescKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  edtValor.Text := CurrToStr(CalcValorDesc);
end;

procedure TfrmInfoBxMultCr.edtValorExit(Sender: TObject);
begin
  edtValor.Text := TUtilitario.FormatarValor(Trim(edtValor.Text));
end;

procedure TfrmInfoBxMultCr.FormCreate(Sender: TObject);
begin
...
procedure TfrmInfoBxMultCr.FormShow(Sender: TObject);
begin
...
procedure TfrmInfoBxMultCr.KeyPressValor(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
...
procedure TfrmInfoBxMultCr.SetDtMaisAnt(const Value: TDate);
begin
  FDtMaisAnt := Value;
end;

procedure TfrmInfoBxMultCr.SetValorPago(const Value: Currency);
begin
  FValorPago := Value;
end;

procedure TfrmInfoBxMultCr.EditKeyPress(Sender: TObject; var Key: Char);
begin
