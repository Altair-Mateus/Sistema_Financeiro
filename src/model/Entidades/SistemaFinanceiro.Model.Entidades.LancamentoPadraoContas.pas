...
type
  ...
  public
    ...
    [TDBColumnAttribute('ID_CLIENTE'), TDBAcceptNull]
...
procedure TModelLancamentoPadrao.AddPropertyToWhere(const APropertyName
  : String);
begin
...
function TModelLancamentoPadrao.UpdateBySQLText(const pWhereClause
  : string): Boolean;
begin
